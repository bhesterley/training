...
*/
	...
	if($msg=="") {
		...
		sqlsrv_query($conn, "INSERT INTO Records (Username, Category, Rev, Evidence, Criteria, Trainer, DateCompleted, Type, Attachment, Initials, Timestamp) VALUES ('$authuser', '$category', " . ($rev=="" ? "NULL" : "'".$rev."'") . ", '$evidence', '$criteria', '$trainer', '$date_completed', 'Other', '$filename', '$initials', GETDATE())"); 
