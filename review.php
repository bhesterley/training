...
<?php
    ...
    echo "<script>var docWindow = window.open('Released_SOPs/".$filename."'); if (!docWindow) {document.write('<font color=red><strong>ALERT:</strong> Your pop-up blocker is preventing the SOP from being displayed. Please set your browser to allow pop-ups from this site, then refresh the page. Contact your IT department if you need assistance.</font>');}</script>";
?>
